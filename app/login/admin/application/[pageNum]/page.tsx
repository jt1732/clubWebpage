...
import { acceptClub, adminLogout, deleteClub, sessionAuth } from '@/src/actions/actions';
        ...
        <table className='table table-striped table-bordered'>
          ...
          {clubs.slice(0, limit).map((club, index) => (
            <tbody key={index}>
              ...
              <td>
                <div>
                    <form action={acceptClub}>
                        <button type='submit' className='btn btn-primary btn-sm' value={club.id} name='clubId'>Accept</button>
                    </form>
